...
void main() async {
  ...
  try {
    ...
    if (responseJson['user'] != null) {
      ...
      // Перевіряємо наявність поля employee_id
      if (responseJson['user']['employee_id'] != null) {
        print('\nFound employee_id: ${responseJson['user']['employee_id']}');
        print('This ID should be used to fetch the employee record with PIN code');
      } else {
        print('\nNo employee_id found in user object');
      }
